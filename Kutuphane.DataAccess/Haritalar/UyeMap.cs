...
namespace Kutuphane.DataAccess.Haritalar
{
    public class UyeMap:EntityTypeConfiguration<Uye>
    {
        public UyeMap()
        {
            ...
            this.Property(c => c.Barkod).HasMaxLength(50) ;
            this.Property(c=>c.Adi).HasMaxLength(50);
            this.Property(c=>c.Soyadi).HasMaxLength(50);
            this.Property(c=>c.YabanciDil).HasMaxLength(50);
